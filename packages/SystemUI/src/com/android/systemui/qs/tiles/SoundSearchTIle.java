...
public class SoundSearchTIle extends QSTileImpl<BooleanState> {
    ...
    public int getMetricsCategory() {
        return MetricsEvent.VORTEX_TILES;
    }
    ...
    public void handleClick() {
        ...
        // Shazam
        if (VortexUtils.isPackageInstalled(mContext, "com.shazam.android") || VortexUtils.isPackageInstalled(mContext, "com.shazam.encore.android")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.shazam.android.intent.actions.START_TAGGING");
            mContext.startActivity(intent);
        // Soundhound
        } else if (VortexUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier.freemium") || VortexUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
            intent.setAction("com.soundhound.android.ID_NOW_EXTERNAL");
            mContext.startActivity(intent);
        // Google Search Music
        } else if (VortexUtils.isPackageInstalled(mContext, "com.google.android.googlequicksearchbox")) {
            Intent intent = new Intent(Intent.ACTION_MAIN);
