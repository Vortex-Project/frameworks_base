...
public class QuickStepController implements GestureHelper {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mNavigationBarView.isDt2s() && isDoubleTapPending) {
                    ...
                    if (isDoubleTapReally) VortexUtils.switchScreenOff(mContext);
                } else {
            ...
            case MotionEvent.ACTION_UP:
               if (mNavigationBarView.isFullGestureMode()) {
                    ...
                    if (mBackActionScheduled) {
                        VortexUtils.sendKeycode(KeyEvent.KEYCODE_BACK, mHandler);
    ...
    private Runnable mDoubleTapCancelTimeout = new Runnable() {
        ...
        public void run() {
            ...
            mHandler.removeCallbacksAndMessages(null);
            VortexUtils.sendKeycode(KeyEvent.KEYCODE_HOME, mHandler);
        }
    };
    ...
    private void moveKbCursor(boolean right, boolean firstTrigger) {
        ...
        VortexUtils.moveKbCursor(KeyEvent.ACTION_UP, right);
        VortexUtils.moveKbCursor(KeyEvent.ACTION_DOWN, right);
